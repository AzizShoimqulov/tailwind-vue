...
const messages = {
  en: {
    ...
    admin: {
      ...
      free_tables: 'Available',
      filter_all: 'All',
      filter_free: 'Free',
      filter_occupied: 'Occupied',
      table_title: 'No.{id} Table',
      occupied_at: 'Occupied at {time}',
      ...
      prepared: 'Prepared',
      cancel: 'Cancel',
      bill_title: 'No.{id} - Table bill',
      order_list: 'Order list',
      total_amount: 'Total amount:',
      close_bill: 'Close bill',
      free_table_confirm: "Do you want to free table No.{id}?",
      currency: "so'm"
    },
    error_page: {
      badge: 'Error!',
  ...
  uz: {
    ...
    admin: {
      ...
      occupied_tables: 'Band qilingan',
      free_tables: "Bo'sh joylar",
      filter_all: 'Barchasi',
      filter_free: "Bo'sh",
      filter_occupied: 'Band',
      table_title: '№{id} Stol',
      occupied_at: '{time} da band qilindi',
      currently_free: "Hozircha bo'sh",
      ...
      cancel: 'Bekor qilish',
      bill_title: '№{id} - Stol hisobi',
      order_list: "Buyurtmalar ro'yxati",
      total_amount: 'Jami summa:',
      close_bill: 'Hisobni yopish',
      free_table_confirm: "№{id}-stolni bo'shatmoqchimisiz?",
      currency: "so'm"
    },
    error_page: {
      badge: 'Xatolik!',
  ...
  tr: {
    ...
    admin: {
      ...
      occupied_tables: 'Dolu',
      free_tables: 'Boş',
      filter_all: 'Hepsi',
      filter_free: 'Boş',
      filter_occupied: 'Dolu',
      table_title: 'No.{id} Masa',
      occupied_at: '{time} saatinde doldu',
      currently_free: 'Şu anda boş',
      ...
      prepared: 'Hazırlandı',
      cancel: 'İptal et',
      bill_title: 'No.{id} - Masa hesabı',
      order_list: 'Sipariş listesi',
      total_amount: 'Toplam tutar:',
      close_bill: 'Hesabı kapat',
      free_table_confirm: 'No.{id} masayı boşaltmak istiyor musunuz?',
      currency: "so'm"
    },
    error_page: {
      badge: 'Hata!',
